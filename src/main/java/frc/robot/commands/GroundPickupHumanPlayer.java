...
public class GroundPickupHumanPlayer extends SequentialCommandGroup {
  /** Creates a new GroundConePickup. */
  public GroundPickupHumanPlayer(Swerve m_swerve, Arm m_arm, Grabber m_grabber, Elevator m_elevator) {
