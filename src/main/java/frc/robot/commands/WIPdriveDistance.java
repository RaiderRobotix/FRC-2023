...
public class WIPdriveDistance extends PIDCommand implements Constants {
  /** Creates a new driveDistance. */
  //Distance is measured in 
  public WIPdriveDistance(Translation2d newPose, SwerveWheelController swerveController) {
    super(
