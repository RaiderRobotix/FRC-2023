...
public class SimpleAutoRamp extends SequentialCommandGroup {
  /** Creates a new SimpleAutoRamp. */
  public SimpleAutoRamp(Swerve m_swerve, Pneumatics m_pneumatics) {
    ...
    addCommands(
      ...
      new WaitCommand(2),
      new DriveAtSpeed(m_swerve, 0.4, 0, 1.8),
      new SetRobotHeading(m_swerve, 90));
