...
public class BumpSideGrabAuto extends SequentialCommandGroup {
  ...
  public BumpSideGrabAuto(Swerve m_swerve, Pneumatics m_pneumatics, Arm m_arm, Elevator m_elevator, Grabber m_grabber) {
    ...
    addCommands(
      ...
      new WaitCommand(1),
      new DriveAtSpeed(m_swerve, 0.1, 0.1, 1), // move up and left to clear bridge
      new WaitCommand(0.5),
      ...
      // new Trigger(m_grabber::grabberIsClosed)
      //   .onTrue(new SequentialCommandGroup(
      //     new DriveAtSpeed(m_swerve, -0.2, -0.2, 1),
      //     new DriveAtSpeed(m_swerve, -0.2, 0, 3))));
