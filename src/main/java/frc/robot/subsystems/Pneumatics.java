...
public class Pneumatics extends SubsystemBase implements UniqueConstants {
  ...
  private static DigitalInput hpTouchSensor;
  ...
  public Pneumatics() {
    ...
    hpTouchSensor = new DigitalInput(0);
  ...
  public static boolean getHpTouchSensor() 
  {
