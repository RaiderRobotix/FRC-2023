...
public interface drivebaseConstants {
    ...
    public final double angleKp = 0.0028;  //Speed
    public final double angleKi = 0.0008;
    public final double angleKd = 0.000;
